...
public class BarChartPane extends StackPane {
    private final BarChart<String, Number> myBart;
    private Konto myKonto;
    private final BarChart<String, Number> secondBart; // a "copy" of a chart to show it in the Graph Shower
