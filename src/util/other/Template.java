...
public class Template
{
    ...
    public static String template = """
            ...
            <div id="ausgabe">
                <table style="border-collapse: collapse; width: 100%; border-radius: 10px; overflow: hidden;">
                    ...
                    <tr style="background-color: #f2f2f2;">
                        <th colspan="3"  style="padding: 8px; border: 1px solid #ddd; font-size: x-large">Geldausgabe</th>
                    </tr>
                    <tr style="background-color: #f2f2f2;">
            ...
            <div id="eingabe">
                ...
                <table style="border-collapse: collapse; width: 100%; border-radius: 5px; overflow: hidden;">
                    ...
                    <tr style="background-color: #f2f2f2;">
                        <th colspan="3"  style="padding: 8px; border: 1px solid #ddd; font-size: x-large">Geldeingabe</th>
                    </tr>
            ...
            <br>
            <br>
            <hr style="height: 4px; background-color: darkslategray; border-color: darkslategray; border-radius: 3px">
            <br>
            <div id="tipp">
                <fieldset style="border-radius: 5px; border-width: 2px">
                    <legend style="text-align: center; font-style: italic; font-size: 24px; font-weight: bold">Zusammenfassung und Tipps</legend>
                    <p id="pTipp">$tipp</p>
                </fieldset>
            </div>
            </body>
    ...
    public static  String help = """
            ...
            <ul>
                ...
                <li><strong>Some Errors</strong>
                    <ul>
                        <li>If you receive this message "<strong>ups an error occurred  &#x1F622</strong>", there was a problem connecting to the Google's service. Here is what to do:
                            <ol>
                                <li>Check first your connection</li>
                                <li>Restart the application and try again</li>
                                <li>If the problem has not been resolved please contact us.</li>
                            </ol>
                        </li>
                    </ul>
                </li>
